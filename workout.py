...
push_up_counter_30s = Challenge("push_up_counter_30s", "counter", "Do as many pushups as you can in 30 sec")
push_up_counter_1m = Challenge("push_up_counter_1m", "counter", "Do as many pushups as you can in 1 min")
...
sit_up_counter_30s = Challenge("sit_up_counter_30s", "counter", "Do as many situps as you can in 30 sec")
sit_up_counter_1m = Challenge("sit_up_counter_1m", "counter", "Do as many situps as you can in 1 min")

push_up = Exercise("Push_Ups", 5, 20, 1, 7, 12, challenges=[push_up_stopwatch_10, push_up_stopwatch_15, push_up_stopwatch_20, push_up_counter_30s, push_up_counter_1m])
